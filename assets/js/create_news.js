...
function buildNewsForm(e){
    ...
    newsTitle = document.querySelector("input[name='news-title']").value;
    newsSubject = document.querySelector("input[name='news-subject']").value;
    newsCategory = document.querySelector("select[name='news-category']").value;
    newsCover = document.querySelector("input[type='file']").files[0];
    newsBody = CKEDITOR.instances.news_body.getData();
